define("common/calendar/1.1.2/month-calendar", ["./calendar.css.js","util/moment/2.5.1/moment","./base-calendar","./month-column","./year-column"], function(require, exports, module){
/**
 * Created by nuintun on 2015/4/20.
 */

'use strict';

require('./calendar.css.js');
    ...
    this.months.on('select', function (value, el){
      ...
      if (el) {
        ...
        if (moment.isMoment(focus)) {
          value = focus.format(this.get('format'));
        }
        self.output(value);
      }
    });
