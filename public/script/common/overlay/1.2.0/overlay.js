define("common/overlay/1.2.0/overlay", ["base/jquery/1.12.4/jquery","util/position/1.1.0/position","util/iframe-shim/1.1.0/iframe-shim","base/widget/1.2.0/widget"], function(require, exports, module){
var $ = require('base/jquery/1.12.4/jquery'),
  Position = require('util/position/1.1.0/position'),
  Shim = require('util/iframe-shim/1.1.0/iframe-shim'),
  Widget = require('base/widget/1.2.0/widget');
