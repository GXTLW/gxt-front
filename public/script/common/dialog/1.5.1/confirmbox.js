define("common/dialog/1.5.1/confirmbox", ["base/jquery/1.12.4/jquery","./dialog","./confirmbox.html"], function(require, exports, module){
var $ = require('base/jquery/1.12.4/jquery'),
  Dialog = require('./dialog');

var template = require('./confirmbox.html');
...
ConfirmBox.alert = function (message, callback, options){
  ...
  return new ConfirmBox($.extend(null, defaults, options)).show().after('hide', function (){
    this.destroy();
  });
};
...
ConfirmBox.show = function (message, callback, options){
  ...
  return new ConfirmBox($.extend(null, defaults, options)).show().before('hide', function (){
    callback && callback.apply(this, arguments);
  }).after('hide', function (){
    this.destroy();
  });
