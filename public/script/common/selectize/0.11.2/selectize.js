define("common/selectize/0.11.2/selectize", ["./selectize.css.js","base/jquery/1.12.4/jquery","./sifter","./microplugin"], function(require, exports, module){
/**
...
$.extend(Selectize.prototype, {
  ...
  refreshClasses: function (){
    ...
    self.$wrapper
      .toggleClass('selectize-active', self.isOpen)
  ...
  open: function (){
    ...
    if (self.isLocked || self.isOpen || !self.hasOptions
      || (self.settings.mode === 'multi' && self.isFull())) return;
    self.focus();
    self.isOpen = true;
    self.refreshState();
...
$.fn.selectize = function (settings_user){
  ...
  return this.each(function (){
    ...
    new Selectize($input, $.extend(true, {}, defaults, settings_element, settings_user));
  });
};
