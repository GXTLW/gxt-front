...
(function() {
  ...
  SWFUpload.prototype.getFlashHTML = function() {
    ...
    return [
      '<object id="', this.movieName, '"' + classid + ' type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
  ...
  SWFUpload.prototype.buildParamString = function() {
    ...
    if (typeof(postParams) === "object") {
      for (var name in postParams) {
        if (postParams.hasOwnProperty(name) && postParams[name]) {
